...
class TextlinksPlugin(Plugin):
    ...
    def begin_text_resource(self, resource, text):
        ...
        def replace_content(match):
            ...
            #return self.template.get_full_url_statement(resource.node.relative_path+"/"+match.groups(1)[0]) #need this for images in rss feed, full url!
            return self.site.config.base_url+resource.node.relative_path+"/"+match.groups(1)[0] #need this for images in rss feed, full url!
